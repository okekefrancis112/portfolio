...
import Resumee from "../assets/Okeke_Francis_CV (2).pdf";
    ...
    <Box id="contact" width={0.95} sx={MyContactStyles} mb={0}>
      <Grid container direction="column">
        ...
        <Box sx={{ margin: " 2rem auto", marginBottom: "0.5rem" }}>
          <MyContactText>Inspired By Vitalik Buterin</MyContactText>
        </Box>
        <Box
          sx={{
            margin: " 0 auto",
        ...
        >
          ...
          <ButtonGroup sx={{ color: "white" }} variant="none">
            <Button href="http://github.com/okekefrancis112">
              <BsGithub />
            </Button>
            <Button href="https://web.facebook.com/okekechukwudalu.francis">
              <BsFacebook />
            </Button>
            <Button href="https://www.linkedin.com/in/okeke-francis-738012125/">
              <BsLinkedin />
            </Button>
            <Button href="https://twitter.com/Francisokeke112">
              <BsTwitter />
            </Button>
          </ButtonGroup>
        </Box>
